...
DOCUMENT_REGISTRY: Dict[str, dict] = {
    ...
    "ata_carnet_procedure": {
        "title_he": "נוהל פנקס ATA (קרנה)",
        "title_en": "ATA Carnet Procedure",
        "category": "procedure",
        "source_xml": None,
        "source_pdf": None,
        "python_module": None,
    ...
    "direct_delivery_procedure": {
        "title_he": "נוהל אספקה ישירה (משלוח ישיר)",
        "title_en": "Direct Delivery / Direct Shipment Procedure",
        "category": "procedure",
        "source_xml": None,
        "source_pdf": None,
        "python_module": None,
    ...
    "ports_ordinance": {
        "title_he": "פקודת הנמלים [נוסח חדש], תשל\"א-1971",
        "title_en": "Ports Ordinance [New Version], 1971",
        "category": "law",
        "source_xml": None,
        "source_pdf": None,
        "python_module": None,
    ...
    "customs_agents_law": {
        "title_he": "חוק סוכני המכס, תשכ\"ה-1964",
        "title_en": "Customs Agents Law, 1964",
        "category": "law",
        "source_xml": None,
        "source_pdf": None,
        "source_url": "https://www.nevo.co.il/law_html/law01/265_023.htm",
        "python_module": "lib._customs_agents_law",
        "python_const": "CUSTOMS_AGENTS_ARTICLES",
        "firestore_collection": None,
        "has_html": False,
        "html_file": None,
        "searchable_via": ["search_legal_knowledge"],
    ...
    "eu_reform": {
        ...
        "category": "reform",
        "source_xml": "downloads/govil/EU_Reform_Information.xml",
        "source_pdf": None,
        "python_module": "lib._eu_reform_data",
        "python_const": "EU_REFORM_DOCS",
        "firestore_collection": "legal_knowledge",
        "has_html": True,
        "html_file": "eu_reform.html",
        "searchable_via": ["search_legal_knowledge"],
        "inline_renderable": True,
        "article_count": None,
        "entry_count": None,
