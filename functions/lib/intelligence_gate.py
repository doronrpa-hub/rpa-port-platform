...
BANNED_PHRASES = [
    ...
    "פנו לעמיל מכס",
    "התייעצו עם עמיל מכס",
    # Hebrew — "contact customs authority" variants (WE are the advisor)
    "מומלץ לפנות לרשות המכס",
    "מומלץ להתייעץ עם רשות המכס",
    "יש לפנות לרשות המכס",
    "פנה לרשות המכס",
    "פנו לרשות המכס",
    "מומלץ לפנות למכס",
    "מומלץ לפנות לגורם מקצועי",
    "יש לפנות לגורם מקצועי",
    # English variants
    ...
    "contact the customs authority",
    "consult the customs authority",
    "recommend contacting customs",
...
CUSTOMS_DOMAINS = {
    ...
    "IP_ENFORCEMENT": {
        "keywords_he": ["זיוף", "מזויף", "קניין רוחני", "סימן מסחר", "עיכוב",
                         "עיכבו", "חשד", "מותג", "העתק", "פיראטיות",
                         "זכויות יוצרים", "טובין מפרים", "בעל זכות",
                         "עיכוב טובין"],
        "keywords_en": ["counterfeit", "fake", "ip", "intellectual property",
                         "trademark", "brand", "piracy", "detained", "seized",
                         "infringing goods"],
        "source_articles": ["200א", "200ב", "200ג", "200ד", "200ה"],
        "source_tools": ["search_legal_knowledge"],
    },
    "FTA_ORIGIN": {
...
_PRODUCT_INDICATORS_HE = {
    ...
    # Common product categories (Bug 3 fix — Session 69)
    "בגדים", "נעליים", "רכב", "מכונה", "אוכל", "מזון", "תרופ",
    "צעצוע", "ריהוט", "כיסא", "שולחן", "מחשב", "טלפון", "בקבוק",
    "שמן", "חלב", "בשר", "דגים", "פירות", "ירקות", "יין", "בירה",
    "קפה", "תה", "סוכר", "אלכוהול", "סבון", "קוסמטיקה", "בושם",
    "צמיג", "סוללה", "כבל", "צינור", "ברגים", "מנוע", "משאבה",
    "גבינה", "חמאה", "יוגורט", "שוקולד", "ממתק", "עוגה", "לחם",
}
