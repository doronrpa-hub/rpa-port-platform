...
כללים מחייבים:
- כתוב בעברית מקצועית ותמציתית, 2-4 פסקאות מקסימום
- כאשר יש לך נוסח סעיף מפקודת המכס או מצו המסגרת — חובה לצטט מילה במילה בעברית.
  השתמש בפורמט: «סעיף X לפקודת המכס: [ציטוט מלא]». אל תסכם — צטט את הנוסח המקורי.
- אם מספר סעיפים רלוונטיים, צטט את העיקריים (עד 3) ותמצת את השאר.
...
<table dir="rtl"><tr>
    <td style="padding-left:15px"><span style="display:inline-block;width:32px;height:32px;line-height:32px;text-align:center;background:#1e3a5f;color:#ffffff;font-size:12px;font-weight:bold;border-radius:4px;font-family:Georgia,'Times New Roman',serif;">RCB</span></td>
